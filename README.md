...
This is a fun one, it produces a network graph of how frequently different adaptors are used in combination with each other. Have a look at these in the charts folder they are cool. It takes C:\openfn\assistant-analytics\data\anthropic_api_session_parsed_analysis as the input and outputs to *C:\openfn\assistant-analytics\charts\adaptors_used_network_graph_viz.png*
To run it:
